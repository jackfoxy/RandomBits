...
let website = "/RandomBits"

let githubLink = "https://github.com/jackfoxy/RandomBits"

// Specify more information about your project
let info =
  [ "project-name", "RandomBits"
    "project-author", "Jack Fox"
    "project-summary", "Random bits from ANU."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/RandomBits" ]
...
let binaries =
    ...
    let conventionBased = 
        ...
        |> Array.map (fun d -> 
            let net45Bin = 
                subDirectories d |> Array.filter(fun x -> x.FullName.ToLower().Contains("net45"))
            let net47Bin =
                subDirectories d |> Array.filter(fun x -> x.FullName.ToLower().Contains("net47"))
